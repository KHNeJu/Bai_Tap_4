...
<form method="post" enctype="multipart/form-data" action="<c:url value='${editing ? "/admin/product/update" : "/admin/product/insert"}'/>">
...
<div class="mb-3"><label>Hoặc tải ảnh vào thư mục uploads/product</label><input class="form-control" type="file" name="imageFile" accept="image/*"></div>
